const projects = [
    {
        ...
        description: "Carddeals(Transcrypto) as i named is a project for trading  all kinds of gift cards this projects makes use of Paystack,firebase and bitcoin API ",
    ...
    },
    {
        ...
        description: "HULP.IO a web based project for NGO's to create causes and get Donations from people ",
        technologyUsed: "React, Firebase, Paystack, Flutterwave, Amplify AWS APPSync & Graphql",
        liveURL: "",
        imageURL: "",
    ...
    },
    {
        ...
        description: "Built the official website for Jpin consultancy firm using wordpress thuis got me a role of SME web consultant for Jpin Trade Partners ",
    ...
    },
    {
        ...
        description: "During the COVID 19 period i got bored and wanted to try out playing a game with my friends since we couldn't be together so i came up with this idea to build a multi player tic tac toe game.NB: The game is still a work in progress",
    ...
    {
        projectName: "Dumont",
        description: "hng-teamfury-org Group 4 we built a simple web page in order to move up to the next stage i and some few other people made this work achieveable",
    ...
    },
    {
        ...
        description: "HNG i6 finance tracker web app used for tracking day to day finances.this app was a joint task and i worked on backend(using NodeJS)",
        technologyUsed: "",
